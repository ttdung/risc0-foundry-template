...
contract CheckSchema {
    ...
    bytes32 public constant imageId = ImageID.CHECK_SCHEMA_ID;
    ...
    function set(bytes calldata journal_input, bytes calldata seal) public {
        // Construct the expected journal data. Verify will fail if journal does not match.
        bytes memory journal = abi.encode(journal_input);
